...
class OpenRCT2Operator(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for index in range(4):
            ...
            subprocess.run("powershell magick '" + filePath + "' -dither FloydSteinberg -define dither:diffusion-amount=" + str(ditherThreshold) + "% -remap '" + paletteFile + "' '" + outputPath + "'")
            ...
            subprocess.run("powershell magick -compose add '" + green + "' '" + purple + "' -composite '" + outputPath + "'");
            ...
            subprocess.run("powershell magick -compose add '" + noRemap + "' '" + outputPath + "' -composite '" + outputPath + "'");
